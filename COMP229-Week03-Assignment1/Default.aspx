...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <a href="Projects.aspx"><img src="Assets/images/thumb_IMG_0366_1024.jpg" height="400" width="450"></a>
            <h4>Projects</h4>
            </div><br>
        <div class="col-md-offset-6 col-md-4">
        <a href="Services.aspx"><img src="Assets/images/thumb_IMG_2346_1024.jpg" height="400" width="450"></a>
            <h4>Services</h4>
            </div>
    </div>
</asp:Content>
